...
> = {
  US: {
    overview: [
      ...
      "Shoppers here rarely regret spending a few extra minutes reading the fine print on returns before checking out.",
      "A short hold time on the support line usually says more about a company than its marketing copy does.",
      "The best way to avoid a bad surprise is to know exactly what happens if you want your money back.",
    ],
    features: [
      ...
      "A checkout that plays nicely with the wallet app already on your phone saves more hassle than it seems.",
      "Rewards points are only worth chasing if redeeming them is actually simple.",
      "The fastest way to judge a retailer's checkout is to see how many steps it takes to actually pay.",
    ],
    whoFor: [
      ...
      "Works well for anyone who'd rather ask a human a question than search a knowledge base for an hour.",
      "A comfortable fit if predictable support hours matter more to you than shaving off a few dollars.",
      "Best suited to buyers who plan to actually use the trial period, not just skip straight to keeping it.",
    ],
    considerations: [
      ...
      "how your state's sales tax gets calculated, when support is actually staffed, and realistic transit time",
      "whether the checkout total already reflects tax, how support hours line up with your schedule, and shipping speed",
      "state sales-tax rules, live support availability, and how many business days shipping realistically takes",
    ],
  ...
  EU: {
    overview: [
      ...
      "A clear answer on where your data lives is worth more to most EU shoppers than a slightly lower price.",
      "The safest first step is confirming your own country's cooling-off period before assuming a generic EU-wide rule applies.",
      "Cross-border shopping only feels safe once you know exactly who to contact if a return goes wrong.",
    ],
    features: [
      ...
      "A checkout that shows your own currency up front avoids an unpleasant surprise on the card statement later.",
      "Look for a data-protection contact based in the EU, not just a generic support inbox.",
      "Pricing that updates automatically for your country's VAT rate is a good sign of a properly localized checkout.",
    ],
    whoFor: [
      ...
      "A solid pick for EU shoppers who read the privacy policy before the product description.",
      "Works well if you'd rather pay in your own currency than guess at a conversion rate.",
      "Fits buyers who want the statutory return window honoured without having to argue for it.",
    ],
    considerations: [
      ...
      "whether your own country's return window applies, how VAT is broken out, and realistic cross-border delivery",
      "how clearly VAT is itemized, what happens if a cross-border return is needed, and typical delivery estimates",
      "VAT transparency, your national cooling-off rights, and how shipping times differ by member state",
    ],
